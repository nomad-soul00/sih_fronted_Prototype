...
import SkeletonLocationSection from "../components/SkeletonLocationSection.jsx"
  ...
  return (
    <div className="space-y-10">
      <header className="space-y-2">
        ...
        <p className="text-gray-700 leading-relaxed max-w-2xl">Upload water quality data to explore HMPI indicators.</p>
      ...
      />
        ...
        <DataPreviewTable data={tableData} caption="Data Preview-HMPI (mg/l)" />
